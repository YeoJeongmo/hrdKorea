	...
	<form method="post" action="action.jsp" name="frm" style="display: flex; justify-content: center; ">
		<table border="1">
			...
			<tr>
				<td> 강의장소 </td>
				<td>
					<input type="radio" name="classArea" value="서울본원">서울본원
					<input type="radio" name="classArea" value="성남분원">성남분원
					<input type="radio" name="classArea" value="대전분원">대전분원
					<input type="radio" name="classArea" value="부산분원">부산분원
					<input type="radio" name="classArea" value="대구분원">대구분원
				</td>
			</tr>
			<tr>
				<td> 강의명 </td>
